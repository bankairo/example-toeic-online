    ...
    <div class="main-content-inner">
        <div class="breadcrumbs" id="breadcrumbs">
            ...
            <ul class="breadcrumb">
                ...
                <li class="active"><fmt:message key="label.upload.audio.image" bundle="${lang}"/></li>
            </ul><!-- /.breadcrumb -->
        </div>
                ...
                <div class="col-xs-12">
                    ...
                    <form action="${formUrl}" method="post" enctype="multipart/form-data" id="formEdit">
                        <div class="form-group">
                            <label class="col-sm-3 control-label no-padding-right"><fmt:message key="label.upload.audio.image" bundle="${lang}"/></label>
                            <div class="col-sm-9">
