                                ...
                                <div class="table-btn-controls">
                                    <div class="pull-right tableTools-container">
                                        <div class="dt-buttons btn-overlap btn-group">
                                            <a flag="info" onclick="update(this)" class="dt-button buttons-colvis btn btn-white btn-primary btn-bold" id="btnAdd"
...
<script>
    ...
    function update(btn) {
        var userEditUrl = $(btn).attr('sc-url');
        if (userEditUrl == undefined) {
            userEditUrl = '${userEditUrl}';
        }
        $('#myModal').load(userEditUrl, '', function () {
        ...
        $("#editUserForm").submit(function (e) {
            ...
            $.ajax({
                ...
                success: function(response){
                    if (response.trim() == "redirect_insert") {
                        $("#crudaction").val("redirect_insert");
                        $("#formUrl").submit();
                    } else if (response.trim() == "redirect_update") {
                        $("#crudaction").val("redirect_update");
                        $("#formUrl").submit();
                    } else if (response.trim() == "redirect_error") {
