...
public class ListenGuidelineController extends HttpServlet {
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if (request.getParameter("listenguidelineid") != null) {
            ListenGuidelineDTO listenGuidelineDTO = SingletonServiceUtil.getListenGuidelineServiceInstance().findListenGuidelineById("listenGuidelineId", Integer.parseInt(request.getParameter("listenguidelineid")));
